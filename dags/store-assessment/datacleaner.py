def data_cleaner():
    ...
    df = pd.read_csv("/Users/syusuf/airflow/dags/store-assessment/store_files_airflow/raw_store_transactions.csv")
    ...
    df.to_csv('/Users/syusuf/airflow/dags/store-assessment/store_files_airflow/clean_store_transactions.csv', index=False)
